...
public class NotificationHeaderView extends ViewGroup {
    ...
    private void updateExpandButton() {
        ...
        mExpandButton.setImageDrawable(ContextCompat.getDrawable(getContext(), drawableId));
        mExpandButton.setColorFilter(mOriginalNotificationColor);
        mExpandButton.setContentDescription(getContext().getText(contentDescriptionId));
    }
