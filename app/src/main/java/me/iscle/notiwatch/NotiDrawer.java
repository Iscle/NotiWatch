...
import me.iscle.notiwatch.view.NotificationHeaderView;
...
public class NotiDrawer {
    ...
    private final PhoneNotification mN;
    private final Style mStyle;
    private final StandardTemplateParams mParams;

    private boolean mUsesStandardHeader;

    public NotiDrawer(Context context, PhoneNotification phoneNotification) {
        this.context = context;
        this.mN = phoneNotification;
    ...
    private static class StandardTemplateParams {
        ...
        final StandardTemplateParams fillTextsFrom(PhoneNotification pn) {
